                        ...
                        <div className="col-md-12">
                            <div className="page-title">
                                <div className="pull-left">
                                    <h1 className="title">Governance Token Address</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-12">
                            <div className="self_address">
                                <h5 className="copydata">Governance Token Address :</h5>
...
export default Governance_token